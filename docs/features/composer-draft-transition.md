...
| **status** | `active` |
| **last verified** | 2026-09-16：定向组件测试 38 项通过（含自适应 hold、漂移钉住、减少动态效果直落）；Client `tsc` 通过；真实浏览器几何回归 4/4 通过（desktop-click / reduced / mobile-enter / multiline）；headed 实测滑行段 ~43 帧满帧单调、无突跳；定向 oxlint 通过。 |
