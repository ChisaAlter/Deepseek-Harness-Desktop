...
function RemoteFlowPane({ open, active, busy, onPicked, onCancel, onError, t }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dshr-flow", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dshr-row", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshr-formLabel dshr-formLabelLeft", children: t("picker.machine") }),
    ...
    path ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("nav", { className: "dshr-crumbNav", "aria-label": t("picker.breadcrumbNavigation"), children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("ol", { className: "dshr-crumbs", children: crumbs.parts && crumbs.parts.length ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(React3.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("li", { className: "dshr-crumbItem", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        "button",
        {
          type: "button",
          className: "dshr-crumb",
          "aria-label": t("picker.breadcrumbNavigate", { path: rootLabel }),
          onClick: () => list(""),
          children: rootLabel
        }
      ) }),
      crumbs.parts.map((c, i) => {
        const current = i === crumbs.parts.length - 1;
        return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(React3.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("li", { className: "dshr-crumbSeparator", "aria-hidden": "true", children: crumbs.sep === "\\" ? "\\" : "\u203A" }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("li", { className: "dshr-crumbItem", children: current ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshr-crumbLast", "aria-current": "page", children: c.name }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "button",
            {
              type: "button",
              className: "dshr-crumb",
              "aria-label": t("picker.breadcrumbNavigate", { path: c.path }),
              onClick: () => list(c.path),
              children: c.name
            }
          ) })
    ...
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("li", { className: "dshr-crumbItem", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshr-crumbLast", "aria-current": "page", children: rootLabel }) }) }) }) : null,
