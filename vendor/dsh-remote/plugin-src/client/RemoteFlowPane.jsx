  ...
  return (
    <div className="dshr-flow">
      <div className="dshr-row">
        <span className="dshr-formLabel dshr-formLabelLeft">{t('picker.machine')}</span>
        <SettingsSelect
      ...
      {path ? (
        <nav className="dshr-crumbNav" aria-label={t('picker.breadcrumbNavigation')}>
          <ol className="dshr-crumbs">
            {crumbs.parts && crumbs.parts.length ? (
              <React.Fragment>
                <li className="dshr-crumbItem">
                  <button
                    type="button"
                ...
                {crumbs.parts.map((c, i) => {
                  ...
                  return (
                    <React.Fragment key={c.path}>
                      <li className="dshr-crumbSeparator" aria-hidden="true">{crumbs.sep === '\\' ? '\\' : '›'}</li>
                      <li className="dshr-crumbItem">
                        {current ? (
                          <span className="dshr-crumbLast" aria-current="page">{c.name}</span>
                        ) : (
                          <button
                            type="button"
                            className="dshr-crumb"
              ...
              <li className="dshr-crumbItem">
                <span className="dshr-crumbLast" aria-current="page">{rootLabel}</span>
              </li>
            )}
          </ol>
        </nav>
