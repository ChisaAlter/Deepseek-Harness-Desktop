 ...
 */
export declare function graphWeeks(days: readonly DayRecord[]): GraphWeek[];
 ...
 */
export declare function graphMonthLabels(weeks: readonly GraphWeek[], minGap?: number): GraphMonthLabel[];
/**
