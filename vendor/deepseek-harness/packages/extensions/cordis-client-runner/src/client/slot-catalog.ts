...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    source: 'packages/client/ui-approval/src/client/contract/slots.ts:38',
  },
  {
  ...
  },
  {
    ...
    keyDomain: 'fixed by the owner\'s key table { [Kind in ChatNodeKind]: { node: ChatNode<Kind> } }, already taken: assistant-step, command, command-input, compaction, context, manual-compaction, model-retry, steering, system-prompt, tool-call, turn-error, turn-max-tokens, turn-process, turn-tail, turn-trigger, unknown, workflow-run',
    ...
    source: 'packages/client/ui-chat/src/client/contract/slots.ts:287',
  },
  {
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Action strip on one finalized USER message, inside that message\'s IconActions row (after copy, before branch).',
    doc: 'Action strip on one finalized USER message, inside that message\'s\nIconActions row (after copy, before branch). Only the `user` node\ndeclares this seat — steering bubbles do not.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-conversation PeakValleyRow id \'peak-valley\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-directory-picker-browse BrowseDirectoryFlowHero',
  ...
  {
    key: 'conversation.hero.workspace.directoryFlow.remote',
    kind: 'single',
    scope: 'root',
    summary: 'Remote-workspace hole inside the hero picker\'s directory dialog (declared by the hero flow entry).',
    doc: 'Remote-workspace hole inside the hero picker\'s directory dialog (declared by the hero flow entry).',
    registerOptions: [],
    ownerProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'conversation.hero.workspace.directoryFlow\' (client-ui-directory-picker-browse), so it exists while that entry is mounted',
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.hero.workspace.directoryFlow.remote\', () => ctx.slots.register(\n      { name: \'conversation.hero.workspace.directoryFlow.remote\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-directory-picker-browse/src/client/contract/slots.ts:36',
  },
  {
    key: 'conversation.image.preview',
    kind: 'single',
    scope: 'session',
    summary: 'Document-level preview for one Markdown-authored image activated from chat content (assistant text or reasoning).',
    doc: 'Document-level preview for one Markdown-authored image activated from\nchat content (assistant text or reasoning). The owner supplies the\nresolved source, alt text, open state, and dismiss callback. A\nregistration supplies the preview surface; without one activations\nrender nothing.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'conversation.view\' (client-ui-chat), so it exists while that entry is mounted',
    occupants: [
      'client-ui-attachment ImagePreview',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'Plugin-owned profile/configuration control inside the composer tool row.',
    doc: 'Plugin-owned profile/configuration control inside the composer tool row.',
    registerOptions: [],
    ownerProps: [
  ...
  {
    key: 'conversation.session.body',
    kind: 'chain',
    scope: 'session',
    summary: 'Desktop presentation takeover for the active Session body.',
    doc: 'Desktop presentation takeover for the active Session body.',
    registerOptions: [
      {
        name: 'select',
        requirement: 'required',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'Desktop sidebar-reopen control adjacent to the Session title.',
    doc: 'Desktop sidebar-reopen control adjacent to the Session title.',
    registerOptions: [],
    ownerProps: [
      '/** The leading seat exposes global navigation independently of a Session. */\nexport interface ConversationHeaderLeadingOwnerProps {\n  /** Marker field: the occupant receives no owner-specific values. */\n  children?: never\n}',
    ],
  ...
  },
  {
    ...
    occupants: [
      'client-ui-conversation TypingFxRow id \'composer-typing-fx\'',
    ],
    replaceRisk: 'none',
    ...
    source: 'packages/client/ui-settings/src/client/contract/slots.ts:131',
  },
  {
    key: 'settings.close',
    kind: 'single',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-conversation CustomInstructionsRow id \'custom-instructions\'',
      ...
      'client-ui-settings-general AutoStartDesktopRow id \'auto-start-desktop\'',
    ...
    source: 'packages/client/ui-settings/src/client/contract/slots.ts:99',
  },
  {
    key: 'settings.header',
    kind: 'single',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-conversation PeakValleySettingsRow id \'official-peak-valley\'',
      ...
      'client-ui-settings-general RemoteWorkspaceRow id \'remote-workspace\'',
    ...
    source: 'packages/client/ui-settings/src/client/contract/slots.ts:116',
  },
  {
  ...
  },
  {
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'settings.pet.item\', () => ctx.slots.register(\n      { name: \'settings.pet.item\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-settings/src/client/contract/slots.ts:146',
  },
  {
  ...
  {
    key: 'settings.remote.tab',
    kind: 'list',
    scope: 'root',
    summary: 'One page inside the desktop Remote settings section (gateway advanced knobs and IM channel config).',
    doc: 'One page inside the desktop Remote settings section (gateway advanced\nknobs and IM channel config). Declared at runtime by ui-settings-remote;\nthe type lives here so the preset dsh-im client can inject the channels\ntab without depending on the Remote package.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'settings.section\' (client-ui-settings-remote), so it exists while that entry is mounted',
    occupants: [
      'client-ui-settings-remote GatewaySettingsTab id \'gateway\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'settings.remote.tab\', () => ctx.slots.register(\n      { name: \'settings.remote.tab\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    source: 'packages/client/ui-layout/src/client/index.ts:135',
  },
  {
    key: 'shell.overlay',
    kind: 'list',
  ...
  },
  {
    ...
    source: 'packages/client/ui-sidebar/src/client/contract/slots.ts:72',
  },
  {
    key: 'sidebar.nav.tab',
    kind: 'list',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-files SidebarFilesPanel',
      'client-ui-files SidebarFilePreview',
      'client-ui-plan PlanPreview',
      'client-ui-preview SidebarPreviewPanel',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Extra controls at the end of the native document preview\'s header.',
    doc: 'Extra controls at the end of the native document preview\'s header.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    keyDomain: '',
    hookContext: 'UseSidebarRightTabInfo',
    slotInject: '{ hooks: { tabInfo: SlotHookFactory< \'sidebar.right.tab.document.actions\', UseSidebarRightTabInfo > } }',
    declaredBy: 'an entry in \'sidebar.right.pane.tab\' (client-ui-sidebar-documentpreview), so it exists while that entry is mounted',
    occupants: [
      'client-ui-files SidebarFloatingPreviewAction id \'floating-preview\'',
    ...
    source: 'packages/client/ui-sidebar-documentpreview/src/client/document/actions.ts:15',
  },
  {
  ...
  },
  {
    ...
    occupants: [
      'client-ui-directory-picker-browse BrowseDirectoryFlowSidebar',
      'client-ui-directory-picker-native NativeDirectoryFlow',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'sidebar.workspaces.directoryFlow.remote',
    kind: 'single',
    scope: 'root',
    summary: 'Remote-workspace hole inside the sidebar browser\'s directory dialog (declared by the sidebar flow entry).',
    doc: 'Remote-workspace hole inside the sidebar browser\'s directory dialog (declared by the sidebar flow entry).',
    registerOptions: [],
    ownerProps: [
      '/**\n * Owner share passed to a remote-flow occupant through the dialog\'s\n * renderSlot call site. The pick outcome is a LOCAL path — the occupant\'s\n * mirror workspace under `$DSH_HOME/remote-workspaces` — so the owner\'s\n * workspace-adoption path needs no remote awareness.\n */\nexport interface RemoteFlowOwnerProps {\n  /** True while the picking dialog is open; flipping back withdraws the request. */\n  open: boolean\n  /** True while the remote tab is the visible pane; a hidden pane keeps state but must not act. */\n  active: boolean\n  /** True while the owner adopts a picked path; commit affordances disable. */\n  busy: boolean\n  /** The operator picked a workspace directory (the remote mirror\'s local path); the owner adopts it. */\n  onPicked: (path: string) => void\n  /** The operator dismissed the whole interaction; the owner just closes the flow. */\n  onCancel: () => void\n  /** The interaction itself failed (connect refused, listing denied); the owner shows its error surface. */\n  onError: (message: string) => void\n}',
    ],
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'sidebar.workspaces.directoryFlow\' (client-ui-directory-picker-browse), so it exists while that entry is mounted',
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspaces.directoryFlow.remote\', () => ctx.slots.register(\n      { name: \'sidebar.workspaces.directoryFlow.remote\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-directory-picker-browse/src/client/contract/slots.ts:38',
  },
  {
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'The upstream surfaces-column Diff seat.',
    doc: 'The upstream surfaces-column Diff seat. A registrant passes its diff\ncomponent and receives the same FilesOwnerProps shell face the\nfile tree uses. A `single` registration replaces the previous occupant.\nDesktop registers nobody: absence leaves the dormant track empty, and\nDiff is served by the native right Sidebar tab.',
    registerOptions: [],
    ownerProps: [
  ...
  },
  {
    ...
    source: 'packages/client/ui-surfaces/src/client/apply.ts:94',
  },
  {
    key: 'surfaces.files',
    kind: 'single',
    scope: 'session-maybe',
    summary: 'The upstream surfaces-column Workspace file-tree seat.',
    doc: 'The upstream surfaces-column Workspace file-tree seat. A registrant\npasses its tree component and receives FilesOwnerProps (the\nsession-scoped shell face plus the open callback). A `single`\nregistration replaces the previous occupant. Desktop registers nobody,\nso absence leaves the dormant track empty; Files is served by the\nnative right Sidebar tab of the same name.',
    registerOptions: [],
    ownerProps: [
      '/** Owner props the Files occupant receives so it can open a file surface. */\nexport interface FilesOwnerProps {\n  openFile: (relativePath: string) => void\n}',
    ],
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'session-maybe',
    summary: 'The upstream surfaces-column terminal seat, whose component takes no owner props.',
    doc: 'The upstream surfaces-column terminal seat, whose component takes no\nowner props. A `single` registration replaces any previous occupant.\nDesktop registers nobody: the bottom terminal drawer owns this surface\ninstead, and absence simply leaves the dormant track empty.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
  ...
  },
  {
    ...
    source: 'packages/client/ui-tool/src/client/contract/slots.ts:36',
  },
  {
    ...
    source: 'packages/client/ui-tool/src/client/contract/slots.ts:22',
  },
  {
