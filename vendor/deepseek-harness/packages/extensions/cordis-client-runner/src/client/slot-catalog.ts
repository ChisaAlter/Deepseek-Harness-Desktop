...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'chain',
    scope: 'session',
    summary: 'Selector-routed replacement for one Session\'s resident Conversation body.',
    doc: 'Selector-routed replacement for one Session\'s resident Conversation body.',
    registerOptions: [
      {
        name: 'select',
        requirement: 'required',
  ...
  },
  {
    ...
    source: 'packages/client/ui-settings/src/client/contract/slots.ts:128',
  },
  {
    key: 'settings.close',
    kind: 'single',
  ...
  },
  {
    ...
    source: 'packages/client/ui-settings/src/client/contract/slots.ts:113',
  },
  {
  ...
  },
  {
    ...
    source: 'packages/client/ui-settings/src/client/contract/slots.ts:143',
  },
  {
