...
import { SessionDeleteGate, wrapAgentFactoryHandles } from './delete-gate.ts'
import { deleteArchivedSession } from './delete.ts'
...
export class SessionController extends TypertRemoteService {
  ...
  private readonly agentHandles = new Map<SessionId, AgentHandle>()
  ...
  constructor(ctx: Context, config: Config, internals: SessionControllerInternals = {}) {
    ...
    const deleteGate = new SessionDeleteGate()
    ctx.provide('sessionDeleteGate', deleteGate)
    wrapAgentFactoryHandles(ctx, this.agentHandles)
  ...
  delete(request: SessionDeleteRequest): Promise<SessionDeleteValue> {
    return deleteArchivedSession(this.ctx, this.agentHandles, request)
  }
