...
Image follow-ups to local continuable children accept a configured vision-fallback route when the primary model is text-only. Child model resolution and authorization remain required.
