...
/** read_image row props: the runtime share, the parent-provided image renderer, and the locale seat. */
 ...
 * that draw it.
 */
export type ReadFamilyCard = Pick<ToolRowProps, 'read' | 'image' | 'renderToolImages' | 'loadImage' | 'filePathLine'>
