...
export function GenericToolCard({ toolName, block, cwd, home, openFile, inspect, useDisclosure, loadImage, renderToolImages, t }: GenericToolCardProps) {
  ...
  const images = genericImageCardModel(block)
