/**
 * Sidebar shell: column geometry, plugin region tabs, and global panel navigation.
 ...
 * the global panel rows and the foot is the `sidebar.workspaces` registrant's
...
import {
  FishLogo, IconAgentPresetOutlineRegular, IconNewChatOutlineMedium, IconNewChatOutlineRegular, IconPanelLeftOutlineRegular, isDarwinDesktop, ShortcutKeys, Tooltip,
      ...
      {navTabs.length > 0 && (
        <div className={css.tabList} role="tablist" aria-label={t('tab.sessions')}>
          ...
          {navTabs.map(row => (
            ...
            >
              <IconAgentPresetOutlineRegular size={wide ? 14 : 18} />
