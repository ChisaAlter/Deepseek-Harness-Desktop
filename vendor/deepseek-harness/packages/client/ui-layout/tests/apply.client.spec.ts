...
describe('ui-layout client apply', () => {
  ...
  it('provides ctx.layout and declares the frame slots (main, rightbar, surfaces, drawer)', async () => {
  ...
  it('teardown unwinds the service, the root registration, and the child declarations', async () => {
    ...
    expect(slots.spec('surfaces')).toBeUndefined()
    expect(slots.spec('shell.overlay')).toBeUndefined()
    expect(slots.spec('shell.titlebar.trailing')).toBeUndefined()
    expect(slots.spec('shell.terminalDrawer')).toBeUndefined()
