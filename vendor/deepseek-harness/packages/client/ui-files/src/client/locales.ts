...
export const zh = {
  ...
  'preview.floating.description': '在原生只读、始终置顶的已保存文件悬浮窗中打开（不会保存或同步未保存编辑）',
  'preview.floating.noCwd': '无法确定文件所属会话的工作区',
  'preview.floating.failed': '悬浮预览打开失败。',
...
export const en = {
  ...
  'preview.floating.description': 'Open the saved file in a native read-only, always-on-top window (unsaved edits are not saved or transferred)',
  'preview.floating.noCwd': 'The workspace for this file’s session is unavailable.',
  'preview.floating.failed': 'Could not open the floating preview.',
