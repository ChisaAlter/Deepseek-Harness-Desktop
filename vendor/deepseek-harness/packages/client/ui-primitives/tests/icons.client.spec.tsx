...
// The paired product glyphs share the IconProps signature. The barrel also
// exports upstream legacy icons and non-icon atoms, so select the two weights
// before applying the paired-glyph contract.
const icons = Object.fromEntries(
  Object.entries(primitives).filter(([name]) => name.startsWith('Icon') && /(?:Regular|Medium)$/.test(name)),
