...
- **No Session deletion on live rows** — archived sessions restore from the Archived section; confirmed Delete session is archived-only. Workspace registration deletion does not delete Sessions.
