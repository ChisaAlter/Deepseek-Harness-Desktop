...
export const zh = {
  ...
  'settings.peakValley.description': '在会话统计下方显示官方峰谷时段状态条。开启后始终显示；关闭时仅在检测到 DeepSeek API 路线时显示。',
  'settings.sessionCost.title': '会话累计费用',
  'settings.sessionCost.description': '在峰谷状态条同行显示当前会话累计费用。',
...
export const en = {
  ...
  'settings.peakValley.description': 'Show the official peak/valley status row under the session stats. On keeps it always visible; off keeps detection-only (a DeepSeek API route).',
  ...
  'settings.sessionCost.description': 'Show the running session cost on the peak/valley row.',
