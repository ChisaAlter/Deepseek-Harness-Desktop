...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /** Desktop presentation takeover for the active Session body. */
    ...
    /** Desktop sidebar-reopen control adjacent to the Session title. */
...
export interface ConversationInjected {
  ...
  /** Connect and open a blank Session that belongs to no Workspace (Host scratch cwd). */
...
export interface ConversationSessionHeaderInjected {
  ...
  readonly hooks: {
    ...
    readonly viewTabs: ObservableSnapshot<boolean>
  }
...
export interface ComposerBarInjected {
  ...
  hooks: {
    ...
    /** Visual tuning for the same running beam. */
    composerBeamStyle: ObservableSnapshot<ComposerBeamStyle>
    /** Whether InputBar shows the edge drag handles. */
