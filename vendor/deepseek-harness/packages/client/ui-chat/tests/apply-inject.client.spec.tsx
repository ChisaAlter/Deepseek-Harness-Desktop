...
async function bench(initialSettings?: ChatSettings, withBrowserRegistry = true, withProcessGroups = true) {
  ...
  const openPath = vi.fn(async (_path: string, _options?: { line?: number; sessionId?: SessionId }) => {})
  ...
  return {
    ...
    layout, openPath, openWorkspacePath, sidebarRight, sidebarRightTabs, session, chatViewApi, rootReference, openSession,
  }
}
