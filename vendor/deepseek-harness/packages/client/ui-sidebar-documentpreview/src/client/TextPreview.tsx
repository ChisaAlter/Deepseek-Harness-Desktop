...
export function TextPreview({
  ...
  const fileOwner = absolutePath === undefined ? undefined : { absolutePath, resourceAddress: tab.contentId }
    ...
    return (
      <div className={css.preview} data-textpreview-state="unsupported" data-textpreview-url={tab.contentId}>
        <div className={css.header}>
          ...
          {fileOwner !== undefined && renderSlot('sidebar.right.tab.document.actions', fileOwner, { hookContext: useTabInfo })}
        </div>
