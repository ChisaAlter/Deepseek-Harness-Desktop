...
export const en = {
  ...
  loading: 'Loading…', backToHarness: 'Back to Whale Isle',
  ...
  settingsSignedOutTitle: 'You are not signed in to DeepSeek',
  settingsSignedOutDescription: 'Sign in to DeepSeek to get your dedicated API Key',
  ...
  quotaDescription: 'Whale Isle cannot start a new task with this account when no balance is available. Would you like to top up? You can also top up later in Settings → Account.',
  quotaTopUp: 'Top up',
...
export const zh: Record<AccountKey, string> = {
  ...
  loading: '加载中…', backToHarness: '返回 Whale Isle',
  ...
  failed: '操作未完成，请重试。',
  settingsSignedOutTitle: '当前未登录 DeepSeek 账号',
  settingsSignedOutDescription: '登录 DeepSeek 账号获取专属 API Key',
  ...
  quotaTitle: '当前无可用余额',
  quotaDescription: '没有可用额度时，Whale Isle 无法开始新的任务，是否前往充值？或者可以稍后前往 设置 → 账号与余额 进行充值。',
  quotaTopUp: '去充值',
