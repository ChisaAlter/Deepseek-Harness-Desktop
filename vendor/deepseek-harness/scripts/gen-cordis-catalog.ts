...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SkillAdminEntry: 'skill management entry is owned by packages/skill/skill-admin/src/types.ts',
  SkillSaveInput: 'skill management input is owned by packages/skill/skill-admin/src/types.ts',
  McpServerStatusView: 'MCP management status view is owned by packages/mcp/mcp-manager/src/types.ts',
  McpProbeRequest: 'MCP probe input is owned by packages/mcp/mcp-manager/src/types.ts',
  ProbeResult: 'MCP probe outcome is owned by packages/mcp/mcp-client/src/probe.ts',
