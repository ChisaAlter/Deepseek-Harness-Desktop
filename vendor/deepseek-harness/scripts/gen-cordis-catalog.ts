...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  settingsNavigation: 'client-side settings open/close controller — packages/client/ui-settings-general/README.md owns the API',
  ...
  sessionLifecycle: 'optional Session Controller handle-retention helper — packages/api/session-controller/src/lifecycle.ts owns the internal contract',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  PendingApprovalRecord: 'service-local record type is owned by packages/interaction/user-approval/src/index.ts',
  ApprovalClaimResult: 'service-local claim result is owned by packages/interaction/user-approval/src/types.ts',
  PendingQuestionRecord: 'service-local record type is owned by packages/interaction/user-questions/src/index.ts',
  QuestionSession: 'service-local session alias is owned by packages/interaction/user-questions/src/index.ts',
  UserQuestionClaimResult: 'service-local claim result is owned by packages/interaction/user-questions/src/types.ts',
  UserQuestionRequestIdType: 'service-local request identity is owned by packages/interaction/user-questions/src/types.ts',
  SessionPresentation: 'session presentation payload is owned by packages/api/session-controller/src/types.ts',
  SessionPresentationRequest: 'session presentation request is owned by packages/api/session-controller/src/types.ts',
  SessionPresentationValue: 'session presentation response is owned by packages/api/session-controller/src/types.ts',
