const VOICE_PROMPT_BLOCK_START = "<chisacode_voice_mode>";
const VOICE_PROMPT_BLOCK_END = "</chisacode_voice_mode>";

const VOICE_AGENT_SYSTEM_INSTRUCTION = [
  "ChisaCode voice mode is now on.",
  "You are the ChisaCode voice assistant.",
...
const VOICE_AGENT_DISABLED_INSTRUCTION = [
  "ChisaCode voice mode is now off.",
