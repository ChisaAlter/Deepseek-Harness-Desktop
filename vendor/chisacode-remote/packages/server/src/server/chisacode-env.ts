...
export type ChisaCodeNodeEnv = "development" | "production" | "test";
...
export function createChisaCodeInternalEnv(baseEnv: NodeJS.ProcessEnv): NodeJS.ProcessEnv {
...
export function resolveChisaCodeNodeEnv(env: NodeJS.ProcessEnv): ChisaCodeNodeEnv | undefined {
  const value = env[CHISACODE_NODE_ENV];
