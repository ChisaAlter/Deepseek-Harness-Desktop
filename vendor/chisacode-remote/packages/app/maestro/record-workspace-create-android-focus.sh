...
OUT_DIR="/tmp/chisacode-workspace-create-android-focus-$(date +%s)"
VIDEO_DIR="/tmp/chisacode-maestro-videos"
DEVICE_VIDEO="/sdcard/chisacode-maestro-workspace-create-focused.mp4"
LOCAL_VIDEO="$VIDEO_DIR/chisacode-maestro-workspace-create-focused.mp4"
