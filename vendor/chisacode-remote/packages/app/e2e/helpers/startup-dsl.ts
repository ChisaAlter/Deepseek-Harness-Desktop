...
const DISABLE_DEFAULT_SEED_ONCE_KEY = "@chisacode:e2e-disable-default-seed-once";
const SEED_NONCE_KEY = "@chisacode:e2e-seed-nonce";
const REGISTRY_KEY = "@chisacode:daemon-registry";
const E2E_KEY = "@chisacode:e2e";
