...
declare global {
  interface Window {
    ...
    __CHISACODE_TERMINAL_WEBVIEW_RECEIVE__?: (message: InboundMessage) => void;
    __CHISACODE_TERMINAL_WEBVIEW_BLUR__?: () => void;
  }
}
...
const TERMINAL_BACKGROUND_CSS_VAR = "--chisacode-terminal-background";
...
window.__CHISACODE_TERMINAL_WEBVIEW_RECEIVE__ = bridge.receive;
window.__CHISACODE_TERMINAL_WEBVIEW_BLUR__ = bridge.blur;
