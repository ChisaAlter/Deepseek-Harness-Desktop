...
describe("web virtualization test overrides", () => {
  it("uses defaults unless explicit positive integer overrides are present", () => {
    const globalWithOverrides = globalThis as typeof globalThis & {
      __CHISACODE_E2E_WEB_PARTIAL_VIRTUALIZATION_THRESHOLD?: unknown;
      __CHISACODE_E2E_WEB_MOUNTED_RECENT_STREAM_ITEMS?: unknown;
    };
    const previousThreshold =
      globalWithOverrides.__CHISACODE_E2E_WEB_PARTIAL_VIRTUALIZATION_THRESHOLD;
    const previousMounted = globalWithOverrides.__CHISACODE_E2E_WEB_MOUNTED_RECENT_STREAM_ITEMS;

    try {
      delete globalWithOverrides.__CHISACODE_E2E_WEB_PARTIAL_VIRTUALIZATION_THRESHOLD;
      delete globalWithOverrides.__CHISACODE_E2E_WEB_MOUNTED_RECENT_STREAM_ITEMS;
      ...
      globalWithOverrides.__CHISACODE_E2E_WEB_PARTIAL_VIRTUALIZATION_THRESHOLD = 6;
      globalWithOverrides.__CHISACODE_E2E_WEB_MOUNTED_RECENT_STREAM_ITEMS = 4;
      ...
      if (previousMounted === undefined) {
        ...
        globalWithOverrides.__CHISACODE_E2E_WEB_MOUNTED_RECENT_STREAM_ITEMS = previousMounted;
      }
    }
  });
});
