...
interface SidebarLongPressMenuController {
  setAnchorRect: (rect: { x: number; y: number; width: number; height: number } | null) => void;
  setOpen: (open: boolean) => void;
}

/** Coordinates sidebar long-press drag, scroll, swipe, and context-menu gestures. */
export function useSidebarLongPressDragInteraction(input: {
  drag: () => void;
  menuController: SidebarLongPressMenuController | null;
}) {
