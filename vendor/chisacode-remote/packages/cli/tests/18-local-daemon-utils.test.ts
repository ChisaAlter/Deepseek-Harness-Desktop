...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("/tmp/chisacode.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("unix:///tmp/chisacode.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("pipe://\\\\.\\pipe\\chisacode-managed-test"), null);
  assert.strictEqual(resolveTcpHostFromListen("\\\\.\\pipe\\chisacode-managed-test"), null);
...

{
  ...
  assert.strictEqual(resolveTcpHostFromListen("C:\\Users\\foo\\.chisacode\\chisacode.sock"), null);
  assert.strictEqual(resolveTcpHostFromListen("D:\\project\\socket"), null);
  assert.strictEqual(resolveTcpHostFromListen("C:\\chisacode.sock"), null);
