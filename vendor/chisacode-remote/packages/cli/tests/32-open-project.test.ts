...
const existingProject = join(await mkdtemp(join(tmpdir(), "chisacode-open-project-")), "project");
...
const previousDesktopCli = process.env.CHISACODE_DESKTOP_CLI;
process.env.CHISACODE_DESKTOP_CLI = "1";
...
process.env.CHISACODE_DESKTOP_CLI = previousDesktopCli;
