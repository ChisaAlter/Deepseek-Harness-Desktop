...
// Used by nix/package.nix's installPhase to materialize $out/lib/chisacode
...
// installPhase copies each path to $out/lib/chisacode/<path>, preserving the
